 ...
 * Delete Alternate Nodes
	...
	Given a Singly Linked List of integers, delete all the alternate nodes 
	in the list.
	Example:
	...
	Input format :
	The first and the only line of input will contain the elements of the Singly Linked 
	List separated by a single space and terminated by -1.
	Output Format :
