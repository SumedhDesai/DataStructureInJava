 ...
 * Nodes without sibling
	...
	For a given Binary Tree of type integer, print all the nodes 
	...
	Output Format:
	The only line of output prints the node data in a top to down 
	fashion with reference to the root. 
	Node data in the left subtree will be printed first and then the 
	right subtree.
