 ...
 * Delete Node In LL
	...
	The second line of each test case contains the integer value of 'POS'. It 
	denotes the position in the linked list from where the node has to be deleted.
	 Remember/Consider :
	...
	Note:
	You are not required to print the output, it has already been taken care of. Just 
